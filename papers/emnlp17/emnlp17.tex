...
\caption{Dataset information. Best per-language lexicon along with its size, number of tags and coverage (``cov.'') over the UD1.3
  ...
  lexicons or morphological analysers are in their {\em coarse} version unless {\em full} is indicated. We also provide the type-token ratio of the 
...
corpora for languages for which we had neither a lexicon nor Polyglot embeddings (Old Church Slavonic, Hungarian, Gothic and Tamil).
