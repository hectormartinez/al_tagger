...
Best performing lexicons often have a reduced tagset. It might come from the fact that fine-grained distinctions can be
made using characters embeddings, whereas lexical information is useful for disambiguating between coarse-grained
PoS. Moreover, larger sets are bound to be sparser and less useful as additional information.
