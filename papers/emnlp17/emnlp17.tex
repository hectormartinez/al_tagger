...
As a complement to the annotated corpora used to train such systems, external lexicons can be a valuable source of information.
First, morphosyntactic lexicons, which provide a large inventory of (word,~PoS)
