...
iters=20
trainer="sgd"
tagger = SimpleBiltyTaggerNoChars(in_dim, h_dim,h_layers,embeds_file=None,lex_file=lexfile)
...
correct, total = tagger.evaluate(test_X, test_Y,out_file="bilty.nochar.LEX2."+args.lang)
