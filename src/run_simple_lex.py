...
iters=20
trainer="sgd"
tagger = SimpleBiltyTagger(in_dim, h_dim,c_in_dim,h_layers,embeds_file=None,lex_file=lexfile)
...
correct, total = tagger.evaluate(test_X, test_Y,out_file="bilty.100ch.LEX."+args.lang)
