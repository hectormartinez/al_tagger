...
iters=20
trainer="sgd"
tagger = SimpleBiltyTaggerNoChars(in_dim, h_dim,h_layers,embeds_file=None)
...
correct, total = tagger.evaluate(test_X, test_Y,out_file="bilty.nochars.nopoly.nolex."+args.lang)
