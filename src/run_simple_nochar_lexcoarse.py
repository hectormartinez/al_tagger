...
iters=20
trainer="sgd"
tagger = SimpleBiltyTaggerNoChars(in_dim, h_dim,h_layers,embeds_file=None,lex_file=lexfile,coarse_lex=1)
...
correct, total = tagger.evaluate(test_X, test_Y,out_file="bilty.nochar.LEXcoarse."+args.lang)
